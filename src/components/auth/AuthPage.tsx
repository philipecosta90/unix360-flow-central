...
export const AuthPage = () => {
  ...
  return <div className="min-h-screen relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-primary/15 rounded-full blur-3xl animate-pulse" style={{
      animationDelay: '1s'
    }} />
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in">
        ...
        <div className="flex justify-center mb-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary text-sm font-medium animate-scale-in">
            ...
            <span>Infraestrutura de Negócio</span>
          </div>
        </div>
        ...
        <Card className="backdrop-blur-xl bg-card/80 border-border/50 shadow-2xl shadow-primary/10">
          <CardHeader className="text-center pb-2">
            ...
            <CardDescription className="text-base">
              {activeTab === "login" ? "Bem-vindo de volta! Entre na sua conta" : "Crie sua conta e comece agora"}
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="pt-2">
            ...
            <Tabs defaultValue="login" value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              <TabsContent value="login" className="mt-0 animate-fade-in">
                <LoginFormTab isLoading={isLoading} setIsLoading={setIsLoading} loginAttempts={loginAttempts} setLoginAttempts={setLoginAttempts} isLockedOut={isLockedOut} setValidationErrors={setValidationErrors} onAccountLockout={handleAccountLockout} />
              </TabsContent>
              
              <TabsContent value="signup" className="mt-0 animate-fade-in">
                <SignupFormTab isLoading={isLoading} setIsLoading={setIsLoading} setValidationErrors={setValidationErrors} />
              </TabsContent>
            </Tabs>
        ...
        {/* Footer text */}
        <p className="text-center text-xs text-muted-foreground mt-6 animate-fade-in" style={{
        animationDelay: '0.3s'
      }}>
