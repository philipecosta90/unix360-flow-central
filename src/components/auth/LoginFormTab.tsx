  ...
  return (
    <form onSubmit={handleLogin} className="space-y-4">
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm animate-fade-in">
          <div className="flex flex-col items-center gap-4 p-8 rounded-2xl bg-card border border-border shadow-2xl animate-scale-in">
            ...
            <div className="text-center">
              <p className="font-medium text-foreground">Conectando com Google</p>
              <p className="text-sm text-muted-foreground mt-1">Aguarde enquanto redirecionamos...</p>
            </div>
          </div>
        </div>
      )}
      ...
      <Button
        ...
        className="w-full h-12 relative overflow-hidden group border-border/60 hover:border-primary/50 hover:bg-primary/5 transition-all duration-300"
      >
        <div className="absolute inset-0 bg-gradient-to-r from-[#4285F4]/10 via-[#34A853]/10 to-[#FBBC05]/10 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
      ...
      <button
        ...
        className="w-full text-xs text-muted-foreground hover:text-foreground hover:underline mt-4 flex items-center justify-center gap-1 transition-colors"
      >
