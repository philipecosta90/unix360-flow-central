...
interface ContractDocumentUploadDialogProps {
  open: boolean;
...
export const ContractDocumentUploadDialog = ({
  open,
  onOpenChange,
  contractId,
  onDocumentAdded
}: ContractDocumentUploadDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Adicionar Documento ao Contrato</DialogTitle>
        </DialogHeader>
